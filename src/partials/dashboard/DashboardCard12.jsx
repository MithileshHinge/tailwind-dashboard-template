        ...
        <div>
          ...
          <ul className="my-1">
            ...
            <li className="flex px-2">
              ...
              <div className="grow flex items-center border-b border-slate-100 text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center"><span className="font-medium text-slate-800">Nick Mark</span> mentioned <span className="font-medium text-slate-800">Sara Smith</span> in a new post</div>
                  <div className="shrink-0 self-end ml-2">
                    <span className="font-medium text-indigo-500">View<span className="inline"> -&gt;</span></span>
                  </div>
                </div>
              </div>
            </li>
            ...
            <li className="flex px-2">
              ...
              <div className="grow flex items-center border-b border-slate-100 text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center">The post <span className="font-medium text-slate-800">Post Name</span> was removed by <span className="font-medium text-slate-800">Nick Mark</span></div>
                  <div className="shrink-0 self-end ml-2">
                    <span className="font-medium text-indigo-500">View<span className="inline"> -&gt;</span></span>
                  </div>
                </div>
            ...
            <li className="flex px-2">
              ...
              <div className="grow flex items-center text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center"><span className="font-medium text-slate-800">Patrick Sullivan</span> published a new <span className="font-medium text-slate-800">post</span></div>
                  <div className="shrink-0 self-end ml-2">
                    <span className="font-medium text-indigo-500">View<span className="inline"> -&gt;</span></span>
                  </div>
                </div>
        ...
        <div>
          ...
          <ul className="my-1">
            ...
            <li className="flex px-2">
              ...
              <div className="grow flex items-center border-b border-slate-100 text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center"><span className="font-medium text-slate-800">240+</span> users have subscribed to <span className="font-medium text-slate-800">Newsletter #1</span></div>
                  <div className="shrink-0 self-end ml-2">
                    <span className="font-medium text-indigo-500">View<span className="inline"> -&gt;</span></span>
                  </div>
                </div>
            ...
            <li className="flex px-2">
              ...
              <div className="grow flex items-center text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center">The post <span className="font-medium text-slate-800">Post Name</span> was suspended by <span className="font-medium text-slate-800">Nick Mark</span></div>
                  <div className="shrink-0 self-end ml-2">
                    <span className="font-medium text-indigo-500">View<span className="inline"> -&gt;</span></span>
                  </div>
                </div>
