        ...
        <div>
          ...
          <ul className="my-1">
            ...
            <li className="flex px-2">
              ...
              <div className="grow flex items-center border-b border-slate-100 text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center"><span className="font-medium text-slate-800">Qonto</span> billing</div>
            ...
            <li className="flex px-2">
              ...
              <div className="grow flex items-center border-b border-slate-100 text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center"><span className="font-medium text-slate-800">Cruip.com</span> Market Ltd 70 Wilson St London</div>
                  <div className="shrink-0 self-start ml-2">
            ...
            <li className="flex px-2">
              ...
              <div className="grow flex items-center border-b border-slate-100 text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center"><span className="font-medium text-slate-800">Notion Labs Inc</span></div>
                  <div className="shrink-0 self-start ml-2">
            ...
            <li className="flex px-2">
              ...
              <div className="grow flex items-center border-b border-slate-100 text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center"><span className="font-medium text-slate-800">Market Cap Ltd</span></div>
                  <div className="shrink-0 self-start ml-2">
            ...
            <li className="flex px-2">
              ...
              <div className="grow flex items-center border-b border-slate-100 text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center"><span className="font-medium text-slate-800">App.com</span> Market Ltd 70 Wilson St London</div>
                  <div className="shrink-0 self-start ml-2">
